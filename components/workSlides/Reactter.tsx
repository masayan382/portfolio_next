...
const Reactter: React.FC = () => {
    const classes = useStyles()
    return (
        <Box sx={{ boxShadow: 5 }}>
            <Card sx={{ maxWidth: 345 }}>
                <CardHeader title="Reactter" />
                <CardMedia
                    component="img"
                    height="194"
                    image="/work/reactter.gif"
                    alt="Reactter"
                />
                ...
                <CardActions disableSpacing>
                    <Link
                        href="https://masataka.site/reactter/"
                        target="_blank"
                    ...
                    <Link
                        href="https://github.com/masayan382/reactter"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <Button size="large" className={classes.root}>
